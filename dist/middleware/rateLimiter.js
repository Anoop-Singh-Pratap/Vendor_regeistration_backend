...
exports.emailTracker = exports.submissionTracker = exports.getTrackerStatus = exports.cleanupTrackers = exports.vendorSubmissionRateLimiter = exports.globalRateLimiter = void 0;
...
exports.emailTracker = emailTracker;
...
const vendorSubmissionRateLimiter = (req, res, next) => {
...
exports.vendorSubmissionRateLimiter = vendorSubmissionRateLimiter;
...
exports.cleanupTrackers = cleanupTrackers;
...
setInterval(exports.cleanupTrackers, 10 * 60 * 1000);
